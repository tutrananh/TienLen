...
import org.youngmonkeys.plugin.PluginEntry;
import org.youngmonkeys.plugin.PluginEntryLoader;
import org.youngmonkeys.app.AppEntry;
import org.youngmonkeys.app.AppEntryLoader;

public class ApplicationStartup {
	
	public static final String ZONE_APP_NAME = "EzyCard"; 
		...
		public EzyPluginEntry load() throws Exception {
			return new PluginEntry() {
				...
				private String getPluginPath(EzyPluginSetting setting) {
					Path pluginPath = Paths.get("EzyCard-plugin");
					if(!Files.exists(pluginPath))
						pluginPath = Paths.get("../EzyCard-plugin");
		...
		public EzyAppEntry load() throws Exception {
			return new AppEntry() {
				...
				private String getAppPath() {
					Path pluginPath = Paths.get("EzyCard-app-entry");
					if(!Files.exists(pluginPath))
						pluginPath = Paths.get("../EzyCard-app-entry");
					return pluginPath.toString();
				}
			};
		}
